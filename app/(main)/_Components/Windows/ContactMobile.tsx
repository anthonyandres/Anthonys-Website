...
function ContactMobile({showContact = () => {}, height}: Props) {
  ...
  return (
    <div style={{height: `${height}vh`}} className={`window-colors prevent-select w-[90vw] border-0 rounded-[0px] gelica`}>
        <IconContext.Provider value={{ className: 'tertiary-window-colors justify-right border-0 size-[20px] transition duration-100 ease-in hover:scale-[110%]' }}>
            <div className='z-10 absolute gap-x-16 justify-center top-2 right-3'>
        ...
        <div className='flex flex-col h-full'>
            ...
            <div className='window-colors grid grid-rows-3 gap-y-0 border-0 pl-10 pr-10 pb-30 pt-5 h-full overflow-y-auto scrollbar-colors'>
                <div className='border-0 secondary-window-colors gelica'>
                    <p className='text-[10vw] text-center'>Contact me!</p>    
                </div>
                <div className='border-0 flex-row justify-center text-center text-[100%]'>
