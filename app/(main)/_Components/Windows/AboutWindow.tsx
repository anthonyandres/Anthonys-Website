                ...
                <div className='border-0 h-full inline-flex flex-col p-4 overflow-y-auto scrollbar-colors'>
                     <div className='window-colors border-3 border-dashed rounded-2xl p-4 grid gap-y-5'>
                        <h2 className='secondary-window-colors text-3xl font-bold text-center'>Hey! I&#39;m Anthony, I am...</h2>
                            ...
                            <div className=''>
                                <p className='bgbg bg-[#d1cca366] rounded-[20px] pt-2 pb-2 pl-5'>Bachelor of Engineering in Computer Engineering <span className={`text-[#919191] text-[15px] gelicaLight`}>(Software Engineering Option)<br/>GPA: 3.27 / 4.33</span></p>
                            </div>
                        ...
                        <p className='window-colors text-2xl text-left font-bold mt-5 gelicaItalic'>My other passions:</p>
                    ...
                    <div className='border-0 grid gap-20 grid-rows-2 grid-cols-1 w-full h-full'>
                        <div className='border-0 w-full h-full flex flex-col justify-center scale-90'>
                            ...
                            <div className='window-colors border-0 h-min z-0 translate-y-60'>
                                <p className={`secondary-window-colors border-0 flex justify-center items-center text-4xl font-extrabold gelicaItalic`}>Anthony Andres</p>
                                <p className={`border-0 flex justify-center items-center text-2xl gelicaItalic`}>Toronto, Ontario based developer</p>
                                <p className={`border-0 flex justify-center items-center text-2xs gelicaItalic`}>BEng. Computer Engineering Toronto Metropolitan University</p>       
                            </div>                             
                        </div>
                    </div>
                </div>            
