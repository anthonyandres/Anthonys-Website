...
function LinksMobile({showLinks = () => {}, height}: Props) {
  ...
  return (
    <div style={{height: `${height}vh`}} className='window-colors prevent-select w-[90vw] border-0 rounded-[0px]'>
        ...
        <div className='flex flex-col gap-y-0 h-full'>
            ...
            <div className={`window-colors overflow-hidden border-0 grid text-xl grid-cols-3 h-full pl-10 pr-10 pt-10 gelica`}>
                <IconContext.Provider value={{ className: 'border-0 size-[20vw]' }}>
                <ScaleIcon>
