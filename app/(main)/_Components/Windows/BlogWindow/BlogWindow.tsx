...
function LinksWindow({showBlog = () => {}}: Props) {
  ...
  return (
    <div className='prevent-select h-[100%] w-[20vw] min-w-[300px] max-w-[300px] border-0 rounded-[0px]'>
        ...
        <div className='flex flex-col gap-y-0 window'>
            ...
            <div className='landingWindow text-[#4a4a4a] overflow-hidden border-0 h-full'>
