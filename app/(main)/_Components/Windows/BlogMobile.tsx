...
function LinksMobile({showBlog = () => {}, height}: Props) {
  ...
  return (
    <div style={{height: `${height}vh`}} className='window-colors prevent-select w-[40vw] border-0 rounded-[0px]'>
            ...
            <div className={`window-colors overflow-hidden border-0 h-full gelica`}>
                <div className='border-0 flex justify-center items-center h-full'>
                    <ScaleIconSilent>
                      ...
                      <IconContext.Provider value={{className: 'size-[15vw]'}}> 
                        <SlSpeech />
                        </IconContext.Provider>
                      </Link>
