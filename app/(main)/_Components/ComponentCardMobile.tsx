...
function ComponentCardMobile({boundingRef, height, children}: PropsWithChildren<Props>) { // 'Card' takes a reference to a DivElement, and uses that as a bounds
...
export default ComponentCardMobile