    ...
    <div ref={boundingRef} className='-z-10 overflow-hidden flex justify-center items-center h-[100vh]'>
        ...
        <div ref={hiddenWindowBoundingRef} className='absolute overflow-hidden pointer-events-none flex justify-center items-center h-[100vh] w-[100vw]'>
            <div className='absolute z-2'>
                <AnimatePresence>
                  {showAbout &&
                    <motion.div className='border-0 translate-y-20 translate-x-[-23vw]' key={'aboutWindow'} initial={{y:'50%', opacity: 0, scale: 0.5}} exit={{y:'50%', opacity: 0, scale: 0.5, transition: {duration: 0.1, ease: 'easeOut'}}} animate={{y: 0, opacity: 1, scale: 1}} transition={{duration: 0.2, ease: 'easeOut'}}>
...
export default MobileIconsMenu